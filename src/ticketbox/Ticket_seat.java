	...
	public Ticket_seat(Sign_in signin) {
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//좌석 선택 안되었을경우 경고창 뜨게 하기. 
				  String lbl4Text = lblNewLabel_4.getText();

			        if (lbl4Text == null) {
			            JOptionPane.showMessageDialog(null, "좌석을 체크하세요 (필수입니다)", "경고", JOptionPane.WARNING_MESSAGE);
			        } else {//왜인지, 이게 안먹힌다. 경고창뜨게하고싶은데......... 수정해보자. **********
